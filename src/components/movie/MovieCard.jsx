...
const MovieCard = ({
    ...
    return (
        <div className='p-3 rounded-xl bg-slate-700 h-full flex flex-col select-none'>
            <div className='w-full h-[270px] rounded-[inherit] mb-4'>
                <img
            ...
            <div className='flex flex-col flex-1 gap-5'>
                ...
                <Button secondary onClick={() => navigate(`/movies/${id}`)}>
                    Watch now
                </Button>
            </div>
        </div>
...
export const MovieCardSkeleton = () => {
    return (
        <div className='p-3 rounded-xl bg-slate-700 h-full flex flex-col select-none'>
            <div className='w-full h-[270px] rounded-[inherit] mb-4'>
                <Skeleton height='100%' borderRadius='12px'></Skeleton>
            </div>
            <div className='flex flex-col flex-1 gap-5'>
                <div className='flex flex-col flex-1 gap-3'>
